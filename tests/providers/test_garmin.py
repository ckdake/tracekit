...
class TestGarminProviderGear:
    ...
    def test_set_gear_gear_not_found_raises(self):
        """Test set_gear raises GarminGearNotFoundError when gear doesn't exist in account."""
        ...
        with pytest.raises(GarminGearNotFoundError) as exc_info:
            provider.set_gear("Unknown Gear", "99999")

        assert exc_info.value.gear_name == "Unknown Gear"
